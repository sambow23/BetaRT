...
public final class GL11 {
    ...
    private static final class Bindings {
        private final Method memAddressSafe;
        ...
        private Bindings(Class<?> gl11Class, Class<?> memoryUtilClass) throws ReflectiveOperationException {
            memAddressSafe = memoryUtilClass.getMethod("memAddressSafe", Buffer.class);
            ...
            glFog = gl11Class.getMethod("glFog", Integer.TYPE, FloatBuffer.class);
            ...
            glGetFloat = gl11Class.getMethod("glGetFloat", Integer.TYPE, FloatBuffer.class);
            glGetString = gl11Class.getMethod("glGetString", Integer.TYPE);
            glLight = gl11Class.getMethod("glLight", Integer.TYPE, Integer.TYPE, FloatBuffer.class);
            glLightModel = gl11Class.getMethod("glLightModel", Integer.TYPE, FloatBuffer.class);
        ...
        public static Bindings load() {
            try {
                ...
                throw new IllegalStateException("Failed to initialize LWJGL 3 GL11 compatibility bindings", exception);
            }
        }

        public long bufferAddress(Buffer buffer) {
            return invokeLong(memAddressSafe, buffer);
        }
        ...
        public void invokeVoid(Method method, Object... arguments) {
            try {
                ...
                throw new IllegalStateException("Failed to invoke GL11 compatibility binding", exception);
        ...
        private RuntimeException rethrow(Throwable cause) {
            ...
            return new IllegalStateException("GL11 compatibility binding failed", cause);
        }
    }
}