...
public final class MinecraftRenderHooks {
    ...
    public static synchronized void setEntityHeldTorch(int entityId, double worldX, double worldY, double worldZ, int itemId) {
    ...
    public static synchronized void setWaterTransmissionSettings(
            float red,
            float green,
            float blue,
        ...
        RemixBridgeNative.nSetWaterTransmissionSettings(
                red,
                green,
                blue,
                measurementDistance,
