...
$runtimeSourceFiles = @(
    ...
    (Join-Path $javaSourceRoot "scene\RemixUndergroundCulling.java"),
    (Join-Path $javaSourceRoot "scene\mcrtx\bridge\UndergroundVisibility.java"),
    (Join-Path $javaSourceRoot "scene\mcrtx\bridge\UndergroundVisibilityWorker.java"),
