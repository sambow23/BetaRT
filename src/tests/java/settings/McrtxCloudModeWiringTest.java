...
public final class McrtxCloudModeWiringTest {
  public static void main(String[] args) throws Exception {
    String remixCloudCapture = read("src/java-src/scene/RemixCloudCapture.java");
    ...
    requireContains(remixCloudCapture, "RemixSceneBridge.clearCloudLayer()", "cloud capture clears stale mesh");
    ...
    String nativeEntry = read("src/java-src/settings/mcrtx/bridge/McrtxGraphicsSettingsNative.java");
    requireContains(nativeEntry, "nSetRemixAtmosphereCloudsEnabled(boolean enabled)", "native declaration");

    String nativeJni = read("src/native/src/settings/jni_settings_graphics.cpp");
