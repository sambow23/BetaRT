...
extends pg {
    ...
    public boolean a(fd fd2, Random random, int n2, int n3, int n4) {
        ...
        for (int i2 = 0; i2 <= this.b; ++i2) {
            ...
            int n6 = in.b(d8 + d12 / 2.0);
            int n7 = in.b(d9 - d13 / 2.0);
            int n8 = in.b(d9 + d13 / 2.0);
            int n9 = in.b(d10 - d12 / 2.0);
            int n10 = in.b(d10 + d12 / 2.0);
            for (int i3 = n5; i3 <= n6; ++i3) {
                for (int i4 = n7; i4 <= n8; ++i4) {
                    for (int i5 = n9; i5 <= n10; ++i5) {
                        int n11;
                        double d14 = ((double)i3 + 0.5 - d8) / (d12 / 2.0);
                        double d15 = ((double)i4 + 0.5 - d9) / (d13 / 2.0);
                        double d16 = ((double)i5 + 0.5 - d10) / (d12 / 2.0);
                        if (!(d14 * d14 + d15 * d15 + d16 * d16 < 1.0) || (n11 = fd2.a(i3, i4, i5)) != uu.F.bn) continue;
